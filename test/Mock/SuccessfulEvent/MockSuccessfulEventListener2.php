...
/**
 * MockSuccessfulEventListener2.php
 *
...
/**
 * Class MockSuccessfulEventListener2
 * @package coffeephp\event
 * @author Danny Damsky <dannydamsky99@gmail.com>
 * @since 2020-09-03
 */
final class MockSuccessfulEventListener2 extends AbstractListener
{
    ...
    {
        $event->addFinalData(static::class, static::class);
    }
}
